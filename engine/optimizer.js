...
function plansFor(queryType, target = {}, relations = [], inclusions = []) {
  ...
  // CQE plan-space expansion — A/B/C legacy conservados (FORCE_PLAN/harness A/B/C
  // intactos); D+ agregan access paths heterogéneos (bm25, rg-files, symbol-lookup)
  // para dar al selector aprendido más opciones donde aplicar la información.
  switch (useConcept ? 'concept' : normalizeType(queryType)) {
    case 'filename':
      base = [
        ...
        { id: 'C', ops: [{ tool: 'bm25', args: [name] }] },
        { id: 'D', ops: [{ tool: 'rg-files', args: [name] }, { tool: 'bm25', args: [name] }] },
      ];
      break;
    case 'concept':
      base = [
        ...
        { id: 'D', ops: [{ tool: 'bm25', args: [name] }, { tool: 'search-code', args: [kw] }, { tool: 'assemble-context', args: [] }] },
        { id: 'E', ops: [{ tool: 'rg-files', args: [name] }, { tool: 'search-code', args: [kw] }, { tool: 'assemble-context', args: [] }] },
        { id: 'F', ops: [{ tool: 'search-semantic', args: [name] }, { tool: 'bm25', args: [name] }] },
      ];
      break;
    case 'pattern':
      base = [
        ...
        { id: 'C', ops: [{ tool: 'rg-files', args: [name] }, { tool: 'search-structure', args: [name] }] },
        { id: 'D', ops: [{ tool: 'search-structure', args: [name] }, { tool: 'search-code', args: [name] }, { tool: 'search-semantic', args: [name] }] },
        { id: 'E', ops: [{ tool: 'bm25', args: [name] }, { tool: 'search-structure', args: [name] }] },
      ];
      break;
    default:
      base = [
        ...
        { id: 'D', ops: [{ tool: 'rg-files', args: [name] }, { tool: 'search-code', args: [name] }] },
        { id: 'E', ops: [{ tool: 'bm25', args: [name] }, { tool: 'search-code', args: [name] }, { tool: 'assemble-context', args: [] }] },
        { id: 'F', ops: [{ tool: 'symbol-lookup', args: [name] }, { tool: 'search-code', args: [name] }] },
      ];
  }
